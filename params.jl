...
initial_sediment_type = CaCO3_sediment; initial_sediment_thickness = 1.
...
mutable struct world_struct
    ...
    sediment_thickness
    sediment_fractions  # sediment_type, x, y
    elevation_offset
    surface_elevation
...
sediment_layer_time_bins = Float32[635,541,250,65,0] # resolution of the sediment record on the plates
...
#sediment_transport_coefficient = 10. * time_step / n_sediment_transport_substeps
# gives a diffusive length scale of 10 my for 1000 km continent, also 10 myr erosion timescale
