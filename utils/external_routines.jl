        ...
        for iy in 1:ny
            if lithology_grid[ix, iy] in [3, 5, 6]
                ...
                if lithology_grid[ix, iy] in [5] # unconsolidated or mixed sed 
                    world.sediment_surface_fractions[ix, iy, CaO_sediment] = 0.5
                elseif lithology_grid[ix, iy] in [3] # siliciclasic sed
                    world.sediment_surface_fractions[ix, iy, CaO_sediment] = 0.8
                else
                    world.sediment_surface_fractions[ix, iy, CaO_sediment] = 0.2
                end
                world.sediment_surface_fractions[ix, iy, CaCO3_sediment] =
                    1.0 - world.sediment_surface_fractions[ix, iy, CaO_sediment]
